...
namespace DevionGames.BehaviorTrees.Actions.UnityRigidbody2D
{
	...
	[Tooltip ("The velocity of the rigidbody at the point Point in local space.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/Rigidbody2D.GetRelativePointVelocity.html")]
	public class GetRelativePointVelocity: Action
	{
		...
		[Shared]
		public Vector2Variable m_StoreRelativePointVelocity;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_StoreRelativePointVelocity.Value = m_Rigidbody2D.GetRelativePointVelocity (relativePoint);
