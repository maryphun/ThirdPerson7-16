...
namespace DevionGames.BehaviorTrees.Actions.UnityRigidbody2D
{
	...
	[Tooltip ("The physical behaviour type of the Rigidbody2D.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/Rigidbody2D-bodyType.html")]
	public class SetBodyType: Action
	{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public RigidbodyType2D m_BodyType;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_Rigidbody2D.bodyType = m_BodyType;
