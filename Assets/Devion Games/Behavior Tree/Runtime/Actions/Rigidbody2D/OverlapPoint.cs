...
namespace DevionGames.BehaviorTrees.Conditionals.UnityRigidbody2D
{
	...
	[Tooltip ("Check if any of the Rigidbody2D colliders overlap a point in space.")]
	...
	public class OverlapPoint: Conditional
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			return m_Rigidbody2D.OverlapPoint (point) ? TaskStatus.Success : TaskStatus.Failure;
		}
	}
}
