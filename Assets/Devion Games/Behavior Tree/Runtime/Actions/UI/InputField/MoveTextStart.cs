...
namespace DevionGames.BehaviorTrees.Actions.UnityInputField
{
	...
	[Tooltip ("Move the caret index to start of text.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/InputField.MoveTextStart.html")]
	public class MoveTextStart: Action
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_InputField.MoveTextStart (shift);
