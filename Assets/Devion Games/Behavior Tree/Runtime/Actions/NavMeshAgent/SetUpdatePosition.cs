...
namespace DevionGames.BehaviorTrees.Actions.UnityNavMeshAgent
{
	...
	[Tooltip ("Sets whether the transform position is synchronized with the simulated agent position.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/NavMeshAgent-updatePosition.html")]
	public class SetUpdatePosition: Action
	{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public BoolVariable m_UpdatePosition;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_NavMeshAgent.updatePosition = m_UpdatePosition.Value;
