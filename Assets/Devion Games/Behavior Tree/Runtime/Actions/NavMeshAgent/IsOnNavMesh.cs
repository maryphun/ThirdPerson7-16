...
namespace DevionGames.BehaviorTrees.Conditionals.UnityNavMeshAgent
{
	...
	[Tooltip ("Is the agent currently bound to the navmesh?")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/NavMeshAgent-isOnNavMesh.html")]
	public class IsOnNavMesh: Conditional
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			return m_NavMeshAgent.isOnNavMesh ? TaskStatus.Success : TaskStatus.Failure;
		}
	}
}
