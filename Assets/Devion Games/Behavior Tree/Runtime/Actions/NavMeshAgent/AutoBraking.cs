...
namespace DevionGames.BehaviorTrees.Conditionals.UnityNavMeshAgent
{
	...
	[Tooltip ("Returns success if the agenet should auto break to avoid overshooting the destination point.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/NavMeshAgent-autoBraking.html")]
	public class AutoBraking: Conditional
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			return m_NavMeshAgent.autoBraking ? TaskStatus.Success : TaskStatus.Failure;
		}
	}
}
