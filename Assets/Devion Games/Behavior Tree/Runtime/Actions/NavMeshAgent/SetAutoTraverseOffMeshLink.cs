...
namespace DevionGames.BehaviorTrees.Actions.UnityNavMeshAgent
{
	...
	[Tooltip ("Should the agent move across OffMeshLinks automatically?")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/NavMeshAgent-autoTraverseOffMeshLink.html")]
	public class SetAutoTraverseOffMeshLink: Action
	{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public BoolVariable m_AutoTraverseOffMeshLink;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_NavMeshAgent.autoTraverseOffMeshLink = m_AutoTraverseOffMeshLink.Value;
