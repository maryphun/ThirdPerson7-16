...
namespace DevionGames.BehaviorTrees.Actions.UnityLineRenderer
{
	...
	[Tooltip("Get the position of a vertex in the line.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/LineRenderer.GetPosition.html")]
	public class GetPosition: Action
	{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		[Tooltip("The index of the position to retrieve.")]
		public IntVariable index;
		[Shared]
		public Vector3Variable m_GetPosition;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_GetPosition.Value = m_LineRenderer.GetPosition(index);
