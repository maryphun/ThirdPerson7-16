...
namespace DevionGames.BehaviorTrees.Actions.UnityCamera
{
	...
	[Tooltip("Set the target display for this Camera.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Camera-targetDisplay.html")]
	public class GetTargetDisplay: Action{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		[Shared]
		public IntVariable m_TargetDisplay;
		...
		public override TaskStatus OnUpdate (){
			if(m_Camera == null){
			 ...
			 m_TargetDisplay.Value = m_Camera.targetDisplay;
