...
namespace DevionGames.BehaviorTrees.Actions.UnityCamera
{
	...
	[Tooltip("Mask to select which layers can trigger events on the camera.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Camera-eventMask.html")]
	public class SetEventMask: Action{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public IntVariable m_EventMask;
		...
		public override TaskStatus OnUpdate (){
			...
			m_Camera.eventMask =  m_EventMask.Value;
