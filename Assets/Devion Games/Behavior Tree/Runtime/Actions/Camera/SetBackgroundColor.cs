...
namespace DevionGames.BehaviorTrees.Actions.UnityCamera
{
	...
	[Tooltip("The color with which the screen will be cleared.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Camera-backgroundColor.html")]
	public class SetBackgroundColor: Action{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public ColorVariable m_BackgroundColor;
		...
		public override TaskStatus OnUpdate (){
			...
			m_Camera.backgroundColor =  m_BackgroundColor.Value;
