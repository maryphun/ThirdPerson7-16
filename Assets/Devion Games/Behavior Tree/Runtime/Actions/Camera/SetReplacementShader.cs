...
namespace DevionGames.BehaviorTrees.Actions.UnityCamera
{
	...
	[Tooltip("Make the camera render with shader replacement.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Camera.SetReplacementShader.html")]
	public class SetReplacementShader: Action
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_Camera.SetReplacementShader(shader, replacementTag.Value);
