...
namespace DevionGames.BehaviorTrees.Actions.UnityCamera
{
	...
	[Tooltip("Is the camera orthographic (true) or perspective (false)?")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Camera-orthographic.html")]
	public class SetOrthographic: Action{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public BoolVariable m_Orthographic;
		...
		public override TaskStatus OnUpdate (){
			...
			m_Camera.orthographic =  m_Orthographic.Value;
