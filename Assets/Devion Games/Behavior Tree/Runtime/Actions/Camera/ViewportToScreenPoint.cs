...
namespace DevionGames.BehaviorTrees.Actions.UnityCamera
{
	...
	[Tooltip("Transforms position from viewport space into screen space.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Camera.ViewportToScreenPoint.html")]
	public class ViewportToScreenPoint: Action
	{
		...
		[Shared]
		public Vector3Variable m_ViewportToScreenPoint;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_ViewportToScreenPoint.Value = m_Camera.ViewportToScreenPoint(position);
