...
namespace DevionGames.BehaviorTrees.Conditionals.UnityAudioSource
{
	...
	[Tooltip ("If success the audio source will automatically start playing on awake.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/AudioSource-playOnAwake.html")]
	public class PlayOnAwake: Conditional
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			return m_AudioSource.playOnAwake ? TaskStatus.Success : TaskStatus.Failure;
		}
	}
}
