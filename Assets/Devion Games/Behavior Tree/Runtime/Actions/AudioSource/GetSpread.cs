...
namespace DevionGames.BehaviorTrees.Actions.UnityAudioSource
{
	...
	[Tooltip ("Gets the spread angle (in degrees) of a 3d stereo or multichannel sound in speaker space.")]
	...
	public class GetSpread: Action
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_Spread.Value = m_AudioSource.spread;
