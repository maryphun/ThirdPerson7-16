...
namespace DevionGames.BehaviorTrees.Conditionals.UnityAudioSource
{
	...
	[Tooltip ("Is the clip playing right now?")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/AudioSource-isPlaying.html")]
	public class IsPlaying: Conditional
	{
		...
		public override TaskStatus OnUpdate ()
		{
			...
			return m_AudioSource.isPlaying ? TaskStatus.Success : TaskStatus.Failure;
		}
	}
}
