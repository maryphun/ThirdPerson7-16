...
namespace DevionGames.BehaviorTrees.Actions.UnityTransform
{
	...
	[Tooltip ("Position of the transform relative to the parent transform.")]
	...
	public class GetLocalPosition: Action
	{
		...
		[Shared]
		public Vector3Variable m_LocalPosition;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_LocalPosition.Value = m_Transform.localPosition;
