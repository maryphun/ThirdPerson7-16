...
namespace DevionGames.BehaviorTrees.Actions.UnityTransform
{
	...
	[Tooltip ("Gets a transform child by index.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/Transform.GetChild.html")]
	public class GetChild: Action
	{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		[Tooltip ("Index of the child transform to return. Must be smaller than Transform.childCount.")]
		public IntVariable index;
		[Shared]
		public TransformVariable m_Child;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_Child.Value = m_Transform.GetChild (index);
