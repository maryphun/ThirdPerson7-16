...
namespace DevionGames.BehaviorTrees.Actions.UnityRigidbody
{
	...
	[Tooltip ("The rotation of the inertia tensor.")]
	[HelpURL ("https://docs.unity3d.com/ScriptReference/Rigidbody-inertiaTensorRotation.html")]
	public class SetInertiaTensorRotation: Action
	{
		[Tooltip ("The game object to operate on.")]
		public GameObjectVariable m_gameObject;
		public Vector3Variable m_InertiaTensorRotation;
		...
		public override TaskStatus OnUpdate ()
		{
			...
			m_Rigidbody.inertiaTensorRotation = Quaternion.Euler (m_InertiaTensorRotation.Value);
